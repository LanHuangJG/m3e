...
The `m3e-react` package provides idiomatic, typed React bindings for the [`m3e`](https://github.com/matraic/m3e/tree/main/packages/web) component suite, exposing its properties, attributes, and native DOM events through a familiar React interface with full ref forwarding and client‑only compatibility.
