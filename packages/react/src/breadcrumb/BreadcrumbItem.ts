...
import { M3eBreadcrumbItemElement } from "m3e/breadcrumb";
export type { BreadcrumbItemCurrent, M3eBreadcrumbItemElement } from "m3e/breadcrumb";

/**
 * React binding for the `m3e-breadcrumb-item` Web Component from `m3e/breadcrumb`.
 *
