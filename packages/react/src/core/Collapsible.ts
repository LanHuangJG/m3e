...
import { M3eCollapsibleElement } from "m3e/core";
export type { M3eCollapsibleElement, CollapsibleOrientation } from "m3e/core";

/**
 * React binding for the `m3e-collapsible` Web Component from `m3e/core`.
 *
