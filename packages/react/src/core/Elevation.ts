...
import { M3eElevationElement } from "m3e/core";
export type { M3eElevationElement, ElevationLevel } from "m3e/core";

/**
 * React binding for the `m3e-elevation` Web Component from `m3e/core`.
 *
