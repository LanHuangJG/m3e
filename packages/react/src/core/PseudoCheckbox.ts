...
import { M3ePseudoCheckboxElement } from "m3e/core";
export type { M3ePseudoCheckboxElement } from "m3e/core";

/**
 * React binding for the `m3e-pseudo-checkbox` Web Component from `m3e/core`.
 *
