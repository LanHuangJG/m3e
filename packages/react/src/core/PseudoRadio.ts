...
import { M3ePseudoRadioElement } from "m3e/core";
export type { M3ePseudoRadioElement } from "m3e/core";

/**
 * React binding for the `m3e-pseudo-radio` Web Component from `m3e/core`.
 *
