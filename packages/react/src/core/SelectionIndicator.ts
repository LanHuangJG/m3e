...
import { M3eSelectionIndicatorElement } from "m3e/core";
export type { M3eSelectionIndicatorElement } from "m3e/core";

/**
 * React binding for the `m3e-selection-indicator` Web Component from `m3e/core`.
 *
