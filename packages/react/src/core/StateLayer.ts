...
import { M3eStateLayerElement } from "m3e/core";
export type { M3eStateLayerElement } from "m3e/core";

/**
 * React binding for the `m3e-state-layer` Web Component from `m3e/core`.
 *
