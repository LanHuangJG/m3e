...
import { M3eTextHighlightElement } from "m3e/core";
export type { M3eTextHighlightElement, TextHighlightMode } from "m3e/core";

/**
 * React binding for the `m3e-text-highlight` Web Component from `m3e/core`.
 *
