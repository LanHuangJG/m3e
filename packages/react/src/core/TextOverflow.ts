...
import { M3eTextOverflowElement } from "m3e/core";
export type { M3eTextOverflowElement } from "m3e/core";

/**
 * React binding for the `m3e-text-overflow` Web Component from `m3e/core`.
 *
