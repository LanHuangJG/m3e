...
import { M3eDateInputElement } from "m3e/date-input";
export type { M3eDateInputElement, DateInputTimeFormat, DateInputType } from "m3e/date-input";

/**
 * React binding for the `m3e-date-input` Web Component from `m3e/datepicker`.
 *
