...
import { M3eDatepickerToggleElement } from "m3e/datepicker";
export type { M3eDatepickerToggleElement } from "m3e/datepicker";

/**
 * React binding for the `m3e-datepicker-toggle` Web Component from `m3e/datepicker`.
 *
